...
if __name__ == '__main__':
    ...
    log.debug(" -- first hyp: (%s, %d, last: hyp: (%s, %d)", hypotheses[0,:], \
    ...
    if DETopts['method'] == 'single_link':
        ...
        while not indexes is None:
            ...
            if left > 1:
                ...
                best_cluster_idx = np.array([[hvalues[:] > 0][0]])
            ...
            detection = merge_cluster(hvalues[best_cluster_idx], hypotheses[best_cluster_idx], im_id)
