...
\todo[inline]{Thinnk of what to write here... previous thought: (weighted difference ( $\frac{d^- - d^+}{d^+}$ ) in distance is a bit difficult to justify, because the decision boundary is shifted, but it is compliant with Boiman's statement that the biggest differences matter most)}
