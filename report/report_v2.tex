...
\todo[inline,color=yellow]{Use the `inproceedings'-tag or `article' for conference proceedings. Now it is mixed. Difference is that inproceedings give you: ``article title. In \emph{Conference}'', whereas articles leave the `In' out.}
