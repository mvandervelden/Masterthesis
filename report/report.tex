...
\begin{abstract}
    ...
    Tests on the TUD Motorbikes and Pascal VOC 2007 benchmark sets show an improved object detection algorithm, that performs reasonably well compared with other approaches. Further research is needed to explore its possibilities in more detail. Not only with respect to performance, but also to its efficiency, as time complexity appear to be prohibitive for large data sets at the moment.
\end{abstract}
